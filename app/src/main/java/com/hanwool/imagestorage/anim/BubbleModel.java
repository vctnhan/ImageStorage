...
public class BubbleModel {
    ...
    private static final float FLAKE_SIZE_LOWER = 40f;
    private static final float FLAKE_SIZE_UPPER = 70f;
    ...
    public static BubbleModel create(int width, int height, Paint paint) {
        ...
        return new BubbleModel(random, position, angle, increment, flakeSize, paint);
    }

    BubbleModel(Random random, Point position, float angle, float increment, float flakeSize, Paint paint) {
        this.random = random;
