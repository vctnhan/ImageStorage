...
class SnowModel {
    ...
    private static final float FLAKE_SIZE_LOWER = 10f;
    private static final float FLAKE_SIZE_UPPER = 30f;
    ...
    public static SnowModel create(int width, int height, Paint paint) {
        ...
        return new SnowModel(random, position, angle, increment, flakeSize, paint);
    }

    SnowModel(Random random, Point position, float angle, float increment, float flakeSize, Paint paint) {
        this.random = random;
