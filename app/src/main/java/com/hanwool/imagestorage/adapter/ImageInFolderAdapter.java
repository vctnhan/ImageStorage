...
public class ImageInFolderAdapter extends RecyclerView.Adapter<ImageInFolderAdapter.ItemHolder> {
    Context context;
    ArrayList<ImageStorage> arrImage;
public static int index = 0;
    public ImageInFolderAdapter(Context context, ArrayList<ImageStorage> arrImage) {
