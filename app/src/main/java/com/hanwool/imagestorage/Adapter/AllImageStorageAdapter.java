...
public class AllImageStorageAdapter extends RecyclerView.Adapter<AllImageStorageAdapter.ItemHolder> {
    Context context;
    ArrayList<ImageStorage> arrImage;
    public static int index = 0;

    public AllImageStorageAdapter(Context context, ArrayList<ImageStorage> arrImage) {
